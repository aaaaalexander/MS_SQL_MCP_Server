...
This module provides tools for summarizing and visualizing SQL data for novice users.
"""
import logging
import asyncio
...
def register(mcp_instance, db_connection_function=None, db_connection_blocking=None, 
    ...
    logger.info("Registered novice enhanced data summary tools with MCP instance")
